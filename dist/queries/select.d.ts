...
export declare class Query<Type1, Alias1 extends string, Type2, Alias2 extends string, Type3, Alias3 extends string, Type4, Alias4 extends string> {
    ...
    private orderParams;
    private limitParam;
    constructor(aliasedTables: AliasedTable<any, any>[], attributes: string[]);
    where<TypeA, AliasA extends string, Key extends keyof TypeA>(table: AliasedTable<TypeA, AliasA>, key: Key, value: TypeA[Key]): this;
